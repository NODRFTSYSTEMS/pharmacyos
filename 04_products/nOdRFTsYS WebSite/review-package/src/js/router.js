...
const ROUTES = {
  ...
  intake: {
    file: 'intake',
    titleEn: 'Client Intake Form - NoDrftSystems',
    titleEs: 'Formulario de cliente - NoDrftSystems',
    descEn: 'Tell us about your project before our first call. Plain-language form — no technical terms needed.',
    descEs: 'Cuéntenos sobre su proyecto antes de nuestra primera llamada. Formulario en lenguaje sencillo — sin términos técnicos.',
  },
};
