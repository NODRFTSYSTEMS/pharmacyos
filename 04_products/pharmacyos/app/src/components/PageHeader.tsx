...
export function PageHeader({ title, breadcrumb, cta }: PageHeaderProps) {
  return (
    <header className="h-20 px-6 flex items-center justify-between bg-[--color-bg-surface] border-b border-[--color-border] shrink-0">
      <div className="flex flex-col gap-0.5 min-w-0">
        <h1 className="type-page-title text-[--color-text-primary] truncate">{title}</h1>
