...
export function AuditLogPage() {
  return (
    <div className="flex flex-col h-full">
      <PageHeader
        title="Audit Log"
        subtitle={`${SAMPLE_ACTIVITY.length} entries · all state-changing actions logged via database triggers`}
        cta={
      ...
      <section className="flex-1 p-6 overflow-y-auto">
        <div className="bg-bg-surface rounded-card shadow-card overflow-hidden">
          <table className="w-full">
            <thead>
              <tr className="bg-bg-subtle border-b border-border sticky top-0">
